...
func registerSecureServerProtocols() {
	...
	accountManagementProtocol.GetPrivateData = nex_account_management.GetPrivateData
	accountManagementProtocol.TestCapability = nex_account_management.TestCapability
	accountManagementProtocol.GetMultiplePublicData = nex_account_management.GetMultiplePublicData
	accountManagementProtocol.GetPublicData = nex_account_management.GetPublicData
	accountManagementProtocol.GetAccountData = nex_account_management.GetAccountData
	...
	friendsWiiUProtocol.UpdateMii = nex_friends_wiiu.UpdateMii
	friendsWiiUProtocol.AddFriendByName = nex_friends_wiiu.AddFriendByName
	friendsWiiUProtocol.AddFriend = nex_friends_wiiu.AddFriend
