...
func GetPrivateData(err error, packet nex.PacketInterface, callID uint32) (*nex.RMCMessage, *nex.Error) {
	if err != nil {
	...
	rmcResponse.MethodID = account_management.MethodGetPrivateData
