...
func TestCapability(err error, packet nex.PacketInterface, callID uint32, uiCapability *types.PrimitiveU32) (*nex.RMCMessage, *nex.Error) {
	if err != nil {
	...
	rmcResponse.MethodID = account_management.MethodTestCapability
